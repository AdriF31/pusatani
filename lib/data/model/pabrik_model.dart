...
class PabrikModel {
  ...
  PabrikModel({this.meta, this.data});

  PabrikModel.fromJson(Map<String, dynamic> json) {
...
class Data1 {
  ...
  Data1({this.id, this.createdAt, this.updatedAt, this.idUser, this.name, this.deskripsi, this.address, this.image, this.status, this.userName});
